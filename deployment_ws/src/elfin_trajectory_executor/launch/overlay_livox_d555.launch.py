...
def _default_mid360():
    ...
    try:
        ...
        pass
    candidates.append(
        "/home/adamliao/work/elfin_humble_ws/deployment_ws/config/MID360s_config.json"
    )
    candidates.append(
...
def _default_scene_tf():
    ...
    try:
        ...
        pass
    candidates.append(
        "/home/adamliao/work/elfin_humble_ws/src/"
...
def generate_launch_description():
    luggage = _share(
        "luggage_description",
        "source the luggage workspace install/setup.bash after livox_ws/env.sh",
    )
    executor = _share(
