#!/usr/bin/env python3
"""Tune EEF sensor mount adapter pose (elfin_link6 -> eef_mount_adapter) via 6 Gazebo joints.
...
DEFAULT_ADAPTER_PARENT = "elfin_link6"
...
class AdapterMountTuneWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("EEF Mount Adapter Tune (elfin_link6 -> eef_mount_adapter)")
